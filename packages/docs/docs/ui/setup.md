...
```html
<script type="module">
	import { FindkitUI } from "https://cdn.findkit.com/ui/v0.14.0/esm/index.js";
...
<script>
  ...
  script.type = "module";
  script.innerHTML = 'import("https://cdn.findkit.com/ui/v0.14.0/esm/index.js").then(onFindkitUIModule)';
