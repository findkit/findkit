...
```html
<script type="module">
	import { FindkitUI } from "https://cdn.findkit.com/ui/v0.22.0-dev.ae10d645fb/esm/index.js";
...
<script>
	...
	script.type = "module";
	script.innerHTML =
		'import("https://cdn.findkit.com/ui/v0.22.0-dev.ae10d645fb/esm/index.js").then(onFindkitUIModule)';
